...
function BookingRow({
  ...
  const { deleteBooking, isDeleting: isDeleteBookingLoading } = useDeleteBookings()
      ...
      <Modal>
        <Menus>
          ...
          <Menus.List id={bookingId}>
            ...
            {status === 'checked-in' && <Menus.Button disabled={isCheckingOut} icon={<HiArrowUpOnSquare />} onClick={() => checkout(bookingId)}> Check Out</Menus.Button>}
        ...
        <Modal.Window name="delete">
          <ConfirmDelete resourceName='booking' onConfirm={() => deleteBooking(bookingId)} disabled={ isDeleteBookingLoading} />
        </Modal.Window>
      </Modal>
    </Table.Row>
  );
